                ...
                <View style={{flex: 1}}>
                    ...
                    <Content>
                        ...
                        (<MapView
                            ...
                            <MapView.Marker coordinate={this.state.a}>
                                <View>
                                    <Icon name='ios-pin' style={{alignSelf: 'center',flex: 1,color: '#222'}} />
                                </View>
                            </MapView.Marker>
                        </MapView>)
                        : <View />
                    ...
                    <View style={styles.slideSelector}>
                        <Card style={styles.footerCard}>
                            <CardItem>
                                ...
                                <Text note style={styles.rider}>Joe</Text>
                            </CardItem>
                    ...
                    <View style={Platform.OS === 'ios' ? styles.iosSrcdes : styles.aSrcdes}>
                        <View style={styles.searchBar}>
                            <TouchableOpacity style={styles.navigateBtn}  onPress={() => this.replaceRoute('startRide')}>
...
export default connect(null, bindActions)(PickRider);
